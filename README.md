...
Answer: Token is used to store encrypted data on a server and can be used as a check to see if a user has logged in.

- [ ] What steps can you take in your web apps to keep your data secure?

Answer:Using tokens and saving any sensitive data in env files

- [ ] Describe how web servers work.

Answer:  Clients/Browsers request data from server and wait for a responce to come back which is what is displayed
